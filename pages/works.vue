  ...
  <div class="content works">
    ...
    <div class="content__wrapper">
      ...
      <div class="works-nav" @click="() => (dropdown = !dropdown)">
        <div
          class="works-nav__list"
          :class="{ 'works-nav__list--open': dropdown }"
        >
          <button
            v-for="(tag, i) in tags"
            :key="i"
      ...
      <div class="works-examples">
        <div
          ...
          :key="i"
          :class="{ 'works-example--hide': !work.visible }"
          class="works-example"
        >
          <NuxtLink
            v-if="work.to !== '/'"
          ...
          <div class="works-example__header">
            <picture>
              <source
                ...
                :srcset="`/img/${work.img[0]}/Mobile/${work.img[1]}.webp`"
                type="image/webp"
              />
              <source
                media="(min-width: 769px)"
                :srcset="`/img/${work.img[0]}/PC/${work.img[1]}.webp`"
                type="image/webp"
              />
              <source
                :srcset="`/img/${work.img[0]}/JPG/${work.img[1]}.png`"
                type="image/png"
              />
              <img
                :srcset="`/img/${work.img[0]}/PC/${work.img[1]}.webp`"
          ...
          <div class="works-example__info">
            ...
            <h3
              v-if="work.to === '/'"
              class="works-example__title works-example__title--dev"
            >
              В разработке
            </h3>
