<template>
  ...
  <header
    ...
    :class="{
      ...
      'header--nocase':
        pages.about || pages.works || pages.contacts || pages.policy,
    }"
  >
    <div
    ...
    >
      ...
      <div
        class="nav"
        :class="{ 'nav--open': menu, 'nav--close': menu === false }"
      >
        <div class="nav__wrapper">
          <nav class="nav__nav">
            <router-link to="/about" class="nav__link" :onclick="clickHandle">
              <sup>01</sup> О нас
            </router-link>
            <router-link to="/works" class="nav__link" :onclick="clickHandle">
              <sup>02</sup> Проекты</router-link
            >
            <router-link
              to="/contacts"
              class="nav__link"
              :onclick="clickHandle"
            >
              <sup>03</sup> Контакты</router-link
            >
          </nav>
