<template>
	...
	<div class="like">
		...
		<div class="like-button">
			...
			<button @click="toggleLike" class="like-button__button" :class="{ 'like-button__button--pressed': pressed }">
				<div class="like-button__img-wrapper">
					<picture>
						<source :srcset="`/img/like/Cat.png`" type="image/png" />
						<img :srcset="`/img/like/Cat.webp`" alt="Поставь котику лайк, если тебе понравилась работа" type="image/webp" class="like-button__img" />
					</picture>
					<picture>
