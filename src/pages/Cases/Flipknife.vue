	...
	data() {
		return {
			...
			gallery: [
				...
				{
					type: 'TwoImage',
					images: [{ url: ['flipknife', '/flipknife-page-img-06'] }, { url: ['flipknife', '/flipknife-page-img-07'] }],
				},
				{
					type: 'TwoImage',
					images: [{ url: ['flipknife', '/flipknife-page-img-08'] }, { url: ['flipknife', '/flipknife-page-img-09'] }],
				},
			],
			titles: [
				{
