	...
	data() {
		return {
			...
			gallery: [
				...
				{
					type: 'TwoImage',
					images: [{ url: ['genezisproject', '/genezisproject-page-img-04'] }, { url: ['genezisproject', '/genezisproject-page-img-05'] }],
				},
				{
					type: 'FourImage',
					images: [
				...
				},
				{
					type: 'TwoImage',
					border: 'simple',
					images: [{ url: ['genezisproject', '/genezisproject-page-img-12'] }, { url: ['genezisproject', '/genezisproject-page-img-13'] }],
				},
			],
			titles: [
				{
