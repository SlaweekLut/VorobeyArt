		...
		<div class="content about-text">
			...
			<div class="content__wrapper about-text__wrapper">
				...
				<p class="about-text__text">
					...
					<br /><br />
					Точный контроль, выстроенные бизнес-процессы и максимальная вовлечённость в каждый проект позволяют вовремя реализовывать задачи. Поверьте, в Ваш проект команда вложит
		...
		<div class="content about">
			<div class="content__wrapper">
				...
				<div class="about__grid">
					<AboutCard :settings="item" :open="openAboutData" @openInfo="openInfo" v-bind:key="key" v-for="(item, key) in cards" />
				</div>
			</div>
		</div>
