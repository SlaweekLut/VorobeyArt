          ...
          <p class="home-slides-pagination__current">
            ...
            <span class="home-slides-pagination__wrapper-col">
              <span
                ...
                :key="n"
                class="home-slides-pagination__active"
                :style="{ right: `${105 * activeSlide}px` }"
                >{{ n }}</span
              >
            </span>
          </p>
...
export default {
    ...
    return {
      ...
      slides: [
        ...
        },
        {
          ...
          title: 'MOTORIKA',
          date: '18/06/20',
          description: 'Эксклюзивный дизайн <br/> футболок',
  ...
  mounted() {
    ...
    const autoSliderFn = () => {
      ...
      this.activeSlide =
        this.activeSlide + 1 === this.slides.length ? 0 : this.activeSlide + 1;
      this.prevSlide =
