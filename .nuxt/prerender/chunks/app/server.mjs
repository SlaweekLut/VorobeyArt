import { getCurrentInstance, version, useSSRContext, defineComponent, computed, ref, h, resolveComponent, shallowRef, reactive, isReadonly, withAsyncContext, createApp, toRef, isRef, nextTick, provide, onErrorCaptured, onServerPrefetch, unref, inject, withCtx, createVNode, createTextVNode, mergeProps, defineAsyncComponent, resolveDynamicComponent, openBlock, createBlock, Suspense, Transition } from 'file:///Users/marinamalova/inWork/VorobeyArt/vorobey/node_modules/vue/index.mjs';
import { $fetch } from 'file:///Users/marinamalova/inWork/VorobeyArt/vorobey/node_modules/ofetch/dist/node.mjs';
import { createHooks } from 'file:///Users/marinamalova/inWork/VorobeyArt/vorobey/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file:///Users/marinamalova/inWork/VorobeyArt/vorobey/node_modules/unctx/dist/index.mjs';
import { useHead, createHead as createHead$1 } from 'file:///Users/marinamalova/inWork/VorobeyArt/vorobey/node_modules/@unhead/vue/dist/index.mjs';
import { renderDOMHead, debouncedRenderDOMHead } from 'file:///Users/marinamalova/inWork/VorobeyArt/vorobey/node_modules/@unhead/dom/dist/index.mjs';
import { renderSSRHead } from 'file:///Users/marinamalova/inWork/VorobeyArt/vorobey/node_modules/@unhead/ssr/dist/index.mjs';
import { createMemoryHistory, createRouter, RouterView } from 'file:///Users/marinamalova/inWork/VorobeyArt/vorobey/node_modules/vue-router/dist/vue-router.node.mjs';
import { createError as createError$1, sendRedirect } from 'file:///Users/marinamalova/inWork/VorobeyArt/vorobey/node_modules/h3/dist/index.mjs';
import { hasProtocol, parseURL, parseQuery, isEqual, joinURL } from 'file:///Users/marinamalova/inWork/VorobeyArt/vorobey/node_modules/ufo/dist/index.mjs';
import { ssrRenderSlot, ssrRenderSuspense, ssrRenderComponent, ssrRenderClass, ssrRenderAttr, ssrRenderAttrs, ssrRenderVNode } from 'file:///Users/marinamalova/inWork/VorobeyArt/vorobey/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/404-07b8ae37.mjs').then((m) => m.default || m)
  },
  {
    name: "about",
    path: "/about",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/about-a9aee99e.mjs').then((m) => m.default || m)
  },
  {
    name: "aladdin",
    path: "/aladdin",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/aladdin-694ace1d.mjs').then((m) => m.default || m)
  },
  {
    name: "contacts",
    path: "/contacts",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/contacts-2f41fc51.mjs').then((m) => m.default || m)
  },
  {
    name: "energotek",
    path: "/energotek",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/energotek-bde640c9.mjs').then((m) => m.default || m)
  },
  {
    name: "energotekAR",
    path: "/energotekAR",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/energotekAR-cda3c3b3.mjs').then((m) => m.default || m)
  },
  {
    name: "flipknife",
    path: "/flipknife",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/flipknife-fa70fc19.mjs').then((m) => m.default || m)
  },
  {
    name: "genezis",
    path: "/genezis",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/genezis-31bac82a.mjs').then((m) => m.default || m)
  },
  {
    name: "goup",
    path: "/goup",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/goup-a81feb76.mjs').then((m) => m.default || m)
  },
  {
    name: "hone",
    path: "/hone",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/hone-7f2f649a.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-3a3d5856.mjs').then((m) => m.default || m)
  },
  {
    name: "izenbot",
    path: "/izenbot",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/izenbot-90c658ad.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/kvanttelekomBrend-15dd15b5.mjs').then((m) => m.default || m)
  },
  {
    name: "marusya",
    path: "/marusya",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/marusya-2d5077e8.mjs').then((m) => m.default || m)
  },
  {
    name: "mobdebut",
    path: "/mobdebut",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/mobdebut-70c1c687.mjs').then((m) => m.default || m)
  },
  {
    name: "motorika",
    path: "/motorika",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/motorika-7688e2bf.mjs').then((m) => m.default || m)
  },
  {
    name: "oceanview",
    path: "/oceanview",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/oceanview-d604fb3f.mjs').then((m) => m.default || m)
  },
  {
    name: "ownwifi",
    path: "/ownwifi",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/ownwifi-66b0163d.mjs').then((m) => m.default || m)
  },
  {
    name: "pawpaw",
    path: "/pawpaw",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/pawpaw-73242568.mjs').then((m) => m.default || m)
  },
  {
    name: "policy",
    path: "/policy",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/policy-ae757c50.mjs').then((m) => m.default || m)
  },
  {
    name: "primetravel",
    path: "/primetravel",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/primetravel-b439b089.mjs').then((m) => m.default || m)
  },
  {
    name: "prozapchast",
    path: "/prozapchast",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/prozapchast-4d6c7867.mjs').then((m) => m.default || m)
  },
  {
    name: "spicynote",
    path: "/spicynote",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/spicynote-185a27dc.mjs').then((m) => m.default || m)
  },
  {
    name: "tomiai",
    path: "/tomiai",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/tomiai-d7196286.mjs').then((m) => m.default || m)
  },
  {
    name: "ukigassen",
    path: "/ukigassen",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/ukigassen-ada7e24a.mjs').then((m) => m.default || m)
  },
  {
    name: "unidance",
    path: "/unidance",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/unidance-20955203.mjs').then((m) => m.default || m)
  },
  {
    name: "wballiance",
    path: "/wballiance",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/wballiance-e9ffe5d9.mjs').then((m) => m.default || m)
  },
  {
    name: "works",
    path: "/works",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/works-1dd87d45.mjs').then((m) => m.default || m)
  },
  {
    name: "ximtexp",
    path: "/ximtexp",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/ximtexp-0f1fe11c.mjs').then((m) => m.default || m)
  },
  {
    name: "xplane",
    path: "/xplane",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/xplane-61889768.mjs').then((m) => m.default || m)
  },
  {
    name: "zolotoaltaya",
    path: "/zolotoaltaya",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/zolotoaltaya-6b1664c1.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-476f9c00.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, __nuxt_component_0 as a, createError as c, entry$1 as default, useNuxtApp as u };
