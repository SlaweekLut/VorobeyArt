...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/404-da067689.js").then((m) => m.default || m)
  },
  {
    name: "about",
    path: "/about",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/about-691db2bb.js").then((m) => m.default || m)
  },
  {
    name: "aladdin",
    path: "/aladdin",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/aladdin-4f889bbf.js").then((m) => m.default || m)
  },
  {
    name: "contacts",
    path: "/contacts",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/contacts-fad90656.js").then((m) => m.default || m)
  },
  {
    name: "energotek",
    path: "/energotek",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/energotek-053efc1c.js").then((m) => m.default || m)
  },
  {
    name: "energotekAR",
    path: "/energotekAR",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/energotekAR-691afd72.js").then((m) => m.default || m)
  },
  {
    name: "flipknife",
    path: "/flipknife",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/flipknife-2baad163.js").then((m) => m.default || m)
  },
  {
    name: "genezis",
    path: "/genezis",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/genezis-70faa4c3.js").then((m) => m.default || m)
  },
  {
    name: "goup",
    path: "/goup",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/goup-84035072.js").then((m) => m.default || m)
  },
  {
    name: "hone",
    path: "/hone",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/hone-e540f4bf.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-67f6df4b.js").then((m) => m.default || m)
  },
  {
    name: "izenbot",
    path: "/izenbot",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/izenbot-9554a6f7.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/kvanttelekomBrend-59088a88.js").then((m) => m.default || m)
  },
  {
    name: "marusya",
    path: "/marusya",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/marusya-c7741ca0.js").then((m) => m.default || m)
  },
  {
    name: "mobdebut",
    path: "/mobdebut",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/mobdebut-c05ed4af.js").then((m) => m.default || m)
  },
  {
    name: "motorika",
    path: "/motorika",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/motorika-1cce9ef6.js").then((m) => m.default || m)
  },
  {
    name: "oceanview",
    path: "/oceanview",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/oceanview-79c79349.js").then((m) => m.default || m)
  },
  {
    name: "ownwifi",
    path: "/ownwifi",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/ownwifi-811593d0.js").then((m) => m.default || m)
  },
  {
    name: "pawpaw",
    path: "/pawpaw",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/pawpaw-7651af1a.js").then((m) => m.default || m)
  },
  {
    name: "policy",
    path: "/policy",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/policy-0b8e5767.js").then((m) => m.default || m)
  },
  {
    name: "primetravel",
    path: "/primetravel",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/primetravel-815b990e.js").then((m) => m.default || m)
  },
  {
    name: "prozapchast",
    path: "/prozapchast",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/prozapchast-be1d3265.js").then((m) => m.default || m)
  },
  {
    name: "services",
    path: "/services",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/services-d72e8034.js").then((m) => m.default || m)
  },
  {
    name: "spicynote",
    path: "/spicynote",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/spicynote-b311d70a.js").then((m) => m.default || m)
  },
  {
    name: "tomiai",
    path: "/tomiai",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/tomiai-e541142b.js").then((m) => m.default || m)
  },
  {
    name: "ukigassen",
    path: "/ukigassen",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/ukigassen-57b34024.js").then((m) => m.default || m)
  },
  {
    name: "unidance",
    path: "/unidance",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/unidance-ded93996.js").then((m) => m.default || m)
  },
  {
    name: "wballiance",
    path: "/wballiance",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/wballiance-a7e570d7.js").then((m) => m.default || m)
  },
  {
    name: "works",
    path: "/works",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/works-b8c0b3f9.js").then((m) => m.default || m)
  },
  {
    name: "ximtexp",
    path: "/ximtexp",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/ximtexp-8dca4b9b.js").then((m) => m.default || m)
  },
  {
    name: "xplane",
    path: "/xplane",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/xplane-817cc3f2.js").then((m) => m.default || m)
  },
  {
    name: "zolotoaltaya",
    path: "/zolotoaltaya",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/zolotoaltaya-f759296c.js").then((m) => m.default || m)
  }
];
...
const Header_vue_vue_type_style_index_0_scoped_d48b1c71_lang = "";
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<!--[--><div class="header-placeholder header-placeholder--home" data-v-d48b1c71></div><header class="${ssrRenderClass([{
  ...
  }, "header"])}" data-v-d48b1c71><div class="${ssrRenderClass([{
    "header__wrapper--open": $data.menu,
    "header__wrapper--line": !$props.home
  }, "header__wrapper"])}" data-v-d48b1c71>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<img class="header-logo__img"${ssrRenderAttr("src", _imports_0)} alt="On Main" data-v-d48b1c71${_scopeId}><span class="header-logo__crumbread" data-v-d48b1c71${_scopeId}></span><span class="header-logo__text" data-v-d48b1c71${_scopeId}>Vorobey Art</span>`);
      } else {
        return [
          createVNode("img", {
  ...
  _push(`</div><div class="header__controllers" data-v-d48b1c71><a href="https://t.me/Vorobey_Art" class="${ssrRenderClass([{ "header-start-button--nav": $data.menu }, "header-start-button header-start-button--pc"])}" data-v-d48b1c71><span data-v-d48b1c71>Обсудить</span><div class="header-start-button__fill" data-v-d48b1c71></div></a><button class="header__lang" data-v-d48b1c71>EN</button></div><button aria-label="Menu navigation" class="${ssrRenderClass([{
    "header-menu--open": $data.menu,
    "header-menu--close": $data.menu === false
  }, "header-menu"])}" data-v-d48b1c71><div class="header-menu__wrapper" data-v-d48b1c71><span class="header-menu__element header-menu__element--1" data-v-d48b1c71></span><span class="header-menu__element header-menu__element--2" data-v-d48b1c71></span><span class="header-menu__element header-menu__element--3" data-v-d48b1c71></span></div></button></div></header><div class="${ssrRenderClass([{ "nav--open": $data.menu, "nav--close": $data.menu === false }, "nav"])}" data-v-d48b1c71><div class="nav__wrapper" data-v-d48b1c71><nav class="nav__nav" data-v-d48b1c71>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/about",
    class: "nav__link",
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<sup data-v-d48b1c71${_scopeId}>/01</sup> О нас `);
      } else {
        return [
  ...
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<sup data-v-d48b1c71${_scopeId}>/02</sup> Услуги `);
      } else {
        return [
  ...
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<sup data-v-d48b1c71${_scopeId}>/03</sup> Проекты `);
      } else {
        return [
  ...
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<sup data-v-d48b1c71${_scopeId}>/04</sup> Контакты `);
      } else {
        return [
  ...
  _push(`<a href="https://t.me/Vorobey_Art" class="${ssrRenderClass([{ "header-start-button--nav": $data.menu }, "header-start-button header-start-button--mobile"])}" data-v-d48b1c71><span data-v-d48b1c71>Обсудить</span><svg width="157" height="41" viewBox="0 0 157 41" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-d48b1c71><path d="M0 4.51866C0 2.06406 1.98985 0.0742188 4.44444 0.0742188H137C148.046 0.0742188 157 9.02852 157 20.0742C157 31.1199 148.046 40.0742 137 40.0742H35.5556C15.9188 40.0742 0 24.1555 0 4.51866Z" fill="#0181C8" data-v-d48b1c71></path></svg><div class="header-start-button__fill" data-v-d48b1c71></div></a></nav><img${ssrRenderAttr("src", _imports_1)} alt="Навигация" class="nav__logo" data-v-d48b1c71></div></div><!--]-->`);
}
...
const PreloaderElement = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$2], ["__scopeId", "data-v-8fbc5582"]]);
...
const Plug_vue_vue_type_style_index_0_scoped_1531726d_lang = "";
const _sfc_main$2 = {
  __name: "Plug",
...
const Plug = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-1531726d"]]);
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-component-55d27ea4.js").then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-277ec475.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
